...
REM 转码
  	...
  	ffmpeg -i "%%a" -vcodec h264 -preset veryfast -tune:v ssim -qmin 19 -crf 22 -maxrate 2500k -bufsize 3000k -r 29.97 -vf unsharp=5:5:0.06:5:5:0.0,scale=1280:-2 "%%a_ok.mp4"
