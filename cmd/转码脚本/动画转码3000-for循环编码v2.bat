REM 视频转码批处理，转码完成之后将源文件统一放到“待删除”中
...
REM 将源文件统一放到“待删除”里面方便删除，这里不建议自动删除，请自行手动删除
...
REM 转码
  	...
  	ffmpeg -i "%%a" -vcodec h264 -preset veryfast -tune:v animation -qmin 18 -crf 22.0 -maxrate 2500k -bufsize 5000k -r 29.97 -vf unsharp=5:5:0.06:5:5:0.0,scale=1280:-2 "%%a_ok.mp4"
