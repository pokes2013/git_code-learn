...
rem ::ffmpeg转码
ffmpeg -i "%~1" -vcodec h264 -preset veryfast -tune:v ssim -qmin 18 -crf 22.0 -maxrate 2500k -bufsize 5000k -r 29.97 -vf unsharp=5:5:0.06:5:5:0.0,scale=1280:-2 "%~dpn1_ok.mp4" && echo 转换OK
